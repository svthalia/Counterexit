...
const DishwasherGallery: FunctionComponent<Props> = (props) => {
  ...
  return (
          <div className={"flex flex-col md:flex-row w-screen md:justify-around filter drop-shadow-lg my-12 justify-center md:h-36"}>
              <div className={"w-1/2 h-1/2 md:w-1/12 md:h-1/12 self-center justify-center m-0"}>
                <Image className={"image m-0"} src={"/Dishwasher/1.png"} alt={"First dishwasher picture"} width={150} height={150} layout={"responsive"} />
              </div>

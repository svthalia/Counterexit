...
const UserContainer: FunctionComponent<Props> = (props) => {
    ...
    return (
        <div id={props.position} className="m-5 px-12 pt-12 pb-7 bg-white rounded-md flex flex-col justify-center">
            <img src="https://avatars.dicebear.com/api/initials/Julian.svg" className="w-32"
